...
//   // hide nav on login/signup handled in App.jsx; Navbar always renders when included
//   return (
//     <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5 bg-gray-900/95 backdrop-blur-lg shadow-lg'>
